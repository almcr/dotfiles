...
map('i', '<C-l>', '<Del>')
map('n', '<A-q>', '<cmd>q<CR>') -- quit
map('n', '<A-h>', '<C-W><C-H>') -- focus left split
map('n', '<A-l>', '<C-W><C-L>') -- focus roght split
map('n', '<A-j>', '<C-W><C-J>') -- focus bottom split
map('n', '<A-k>', '<C-W><C-K>') -- focus top split
